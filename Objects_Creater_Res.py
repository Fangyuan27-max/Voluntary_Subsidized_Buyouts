...
def CreateRes(resident_info, ead_info, colname, startcol,  disMethod, disRate, alpha, inflaRate, calLength, totalLength):
    ...
    for index, res in resident_info.iterrows():
        ...
        resident.expectedFutureLoss(calLength, totalLength)
